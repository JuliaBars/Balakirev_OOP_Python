...
P.S. Отображать на экране ничего не нужно, только создать объекты по указанным
требованиям.
"""
...
cart.add(TV('xiaomi', 24000))
cart.add(TV('ikea', 4000))
cart.add(Notebook('Mac', 54000))
cart.add(Notebook('huawei', 48000))
cart.add(Cup('present', 1000))
