"""
Подвиг 7. Имеется следующий класс для считывания информации из входного
потока - class StreamReader
...
class StreamData:
    ...
    def create(self, fields, lst_values):
        # функция zip работает по длине самого короткого списка, всё,
        # что длинеее, выкидывает, но проверка длины списка требуется
        # по условию задачи
